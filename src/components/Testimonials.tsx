      ...
      <div className="w-full max-w-6xl mx-auto px-2 md:px-8 flex flex-col items-center justify-center relative z-10" style={{ minHeight: '24vh' }}>
        ...
        <div className="w-full max-w-5xl flex items-center justify-center">
          ...
          <div className="md:hidden w-full text-center px-4">
            <blockquote className="text-white text-lg font-medium leading-relaxed mb-4 italic" style={{ fontFamily: 'Inter, Satoshi, serif' }}>
              {testimonials[index].text}
            </blockquote>
            <div className="text-white/80 font-semibold text-base mb-1" style={{ fontFamily: 'Inter, Satoshi, sans-serif' }}>
              {testimonials[index].author}
            </div>
            <div className="text-[#7BB9E8] text-sm font-medium tracking-wide uppercase" style={{ fontFamily: 'Inter, Satoshi, sans-serif' }}>
          ...
          <div className="hidden md:flex flex-row items-center bg-[#eaf3fa]/90 border border-[#7BB9E8] rounded-xl shadow-lg w-full p-8 gap-8 min-h-[320px]" style={{ boxShadow: '0 6px 32px 0 rgba(123,185,232,0.10)', transform: 'translateY(8%)' }}>
            ...
            {testimonials[index].logo && (
              <img
                ...
                className="h-28 w-28 object-contain mb-2 flex-shrink-0"
