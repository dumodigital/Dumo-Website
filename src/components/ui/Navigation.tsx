...
const Navigation = () => {
  ...
  const scrollToSection = (href: string) => {
    ...
    if (element) {
      const headerHeight = 88; // Height of the sticky navigation
  ...
  // Smooth sticky header with simplified logic
  useEffect(() => {
    let ticking = false;
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .animate-slide-down {
          animation: slide-down 0.7s cubic-bezier(0.25,0.1,0.25,1) forwards;
        }
      `}</style>
    </>
  );
