  ...
  return (
    <>
      ...
      >
        ...
        <button
          className="fixed right-0 top-0 z-[60] text-[#7BB9E8] text-3xl p-2 rounded-bl-xl focus:outline-none md:hidden"
          onClick={() => setOpen(false)}
        ...
        <div className="flex justify-center items-center pb-6">
          <img src="/images/keenan-logo.png" alt="Keenan Logo" className="h-12 w-auto object-contain" style={{ maxWidth: 80 }} />
        </div>
